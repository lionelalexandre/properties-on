...
# [ "C",                 (-0.95231700,    0.00045000,   -0.54975900)],
# [ "C",                 (-0.95251300,    0.00131500,    1.94466800)],
# [ "C",                 ( 1.20783100,    0.00063400,    3.19237800)],
# [ "C",                 ( 3.36840300,   -0.00125800,    1.94524400)],
# [ "C",                 ( 3.36846300,   -0.00263100,   -0.54990300)],
# [ "C",                 ( 1.20815900,   -0.00086200,   -1.79698600)],
# ]
# mol.basis = {
#     "C": '6-31g',
#     "H": '6-31g',
...
class TestNMRShielding(unittest.TestCase):
    ...
    def test_tc2_method_common_gauge_cphf(self):
        nmr =  NMR(mf)
        nmr.cphf = True
        nmr.gauge_orig = (1,1,1)
        msc = nmr.shielding(method='tc2')
    ...
    def test_hpcp_method_cphf(self):
        nmr =  NMR(mf)
        nmr.cphf = True
        nmr.gauge_orig = None
        msc = nmr.shielding(method='hpcp')
    ...
    def test_hpcp_method_common_gauge_cphf(self):
        nmr =  NMR(mf)
        nmr.cphf = True
        nmr.gauge_orig = (1,1,1)
        msc = nmr.shielding(method='hpcp')
